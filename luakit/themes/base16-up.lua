...
local base06 = "#edeceb" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#802629" -- red
local base09 = "#ad9266" -- orange
local base0A = "#997940" -- yellow
local base0B = "#006b5b" -- green
local base0C = "#7b98ac" -- aqua/cyan
local base0D = "#185a7d" -- blue
local base0E = "#894943" -- purple
